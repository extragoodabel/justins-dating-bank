...
import { PRESET_PROFILE_SETS, PROMPTS } from './data/promptBank'
import type {
  Answer,
  AnswerTier,
  Category,
...
export default function PromptBankApp() {
  const {
    ...
    clearFinalSet,
    applyPresetSlots,
  } = usePromptBankPersistence(PROMPTS)
  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-[#0B0B0B] text-[#F5F5F5]">
      <div
        ref={stickyChromeRef}
        className="sticky top-0 z-30 shrink-0 border-b border-[#2A2A2A] bg-[#0B0B0B]/95 backdrop-blur-md"
      >
        <div
